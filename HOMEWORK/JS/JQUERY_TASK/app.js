...
let sortOlunmus = countries_data.sort((a, b) => b.population - a.population).slice(0, 10)
let areaSort = countries_data.sort((a, b) => b.area - a.area).slice(0, 10)

let world = 0
countries_data.forEach(arr => {
    world += arr.population
})
...
populationBtn.addEventListener('click', function () {
    ...
    let html12 = `<h3  class='world'>World <div class="orta"><div class='ortaicindeOrta'></div></div> ${world}</h3>`
    box.insertAdjacentHTML("beforeend", html12);



    sortOlunmus.forEach(element => {
        let html =
            `<h3 class='h3Elem'>${element.name} <div class="orta"><div class='ortaicindeOrta'></div></div>
            ${element.population}</h3>
        `;
...
$("#areaBtn").on('click', function () {
    ...
    areaSort.forEach(q => {
        let html =
            `<h3 class='h3Elem'>${q.name} <div class="orta"><div class='ortaicindeOrta'></div></div> ${q.area}</h3>
        `;
